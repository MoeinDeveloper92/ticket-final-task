...
//Get all tickets
export const getTicekts = createAsyncThunk("ticket/getAll", async (_, thunkAPI) => {
    try {
        const token = thunkAPI.getState().auth.user.token
...
export const ticketSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(getTicekts.pending, (state) => {
                state.isLoading = true
            })
            .addCase(getTicekts.fulfilled, (state, action) => {
                state.isLoading = false
                state.isSuccess = true
                state.tickets = action.payload
            })
            .addCase(getTicekts.rejected, (state, action) => {
                state.isLoading = false
                state.isError = true
                state.message = action.payload
            })
